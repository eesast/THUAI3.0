...
struct Condiment
{
const static double ScoreParameter = 0.3;
};
struct SpaceGate
{
...
struct Condiment
{
const static double ScoreParameter = 0.5;
};
};
};
struct DishProperty
...
{int(Protobuf::TomatoFriedEggNoodle), {Protobuf::Noodle,Protobuf::Tomato,Protobuf::Fried,Protobuf::Egg} },
{int(Protobuf::BeefNoodle), {Protobuf::Beef,Protobuf::Noodle} },
{int(Protobuf::OverRice), {Protobuf::Pork,Protobuf::Cabbage,Protobuf::Rice} },
{int(Protobuf::YellowPheasant), {Protobuf::Chicken,Protobuf::Meat,Protobuf::Potato,Protobuf::Rice} },
{int(Protobuf::Barbecue), {Protobuf::Lettuce,Protobuf::Pork} },
{int(Protobuf::FrenchFries), {Protobuf::Potato,Protobuf::Ketchup} },
{int(Protobuf::PlumJuice), {Protobuf::Dark,Protobuf::Plum,Protobuf::Hawthorn} },
...
{int(Protobuf::PopcornChicken), {Protobuf::Chicken,Protobuf::Meat,Protobuf::Ketchup} },
